...
namespace AI
{
    ...
    /// Changes:
    /// - Refactored.
    /// - Made serialization via ISerializationCallbackReceiver interface.
    ///
    /// Problem:
    /// - It is not possible to use duplicate items in Inspector.
    ...
    ///
    /// TODO:
    /// - Remake OnAfterDeserialize to make possible use of duplicate items.
    ...
    /// - List methods without notification (optional bool argument).
    /// </summary>
    [Serializable]
