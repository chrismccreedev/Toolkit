...
//         /// </summary>
//         public static void SafeInvoke<TTarget, TValue>(this MethodCaller<TTarget, TValue> caller, TTarget target,
//             params object[] args)
//         {
//             if (caller != null)
//                 caller(target, args);
...
//         /// </summary>
//         public static void SafeInvoke<TTarget, TValue>(this MemberSetter<TTarget, TValue> setter, ref TTarget target,
//             TValue value)
//         {
//             if (setter != null)
...
//         /// </summary>
//         public static void GenDebugAssembly(string name, FieldInfo field, PropertyInfo property, MethodInfo method,
//             Type targetType, Type[] ctorParamTypes)
//         {
...
//         /// if 'targetType' and 'ctorParamTypes' are not null, it generates a constructor for the target type that takes the specified arguments
//         /// </summary>
//         public static void GenDebugAssembly<TTarget>(string name, FieldInfo field, PropertyInfo property,
//             MethodInfo method, Type targetType, Type[] ctorParamTypes)
//         {
...
//                 emit.il = buildMethod("FieldSetter", typeof(void),
//                     new Type[] {typeof(TTarget).MakeByRefType(), fieldType});
...
//                 emit.il = buildMethod("PropertySetter", typeof(void),
//                     new Type[] {typeof(TTarget).MakeByRefType(), propType});
...
//         {
//             return member.GetHashCode() ^ dynMethodName.GetHashCode() ^ typeof(T).GetHashCode() ^
//                    typeof(R).GetHashCode();
//         }
//
...
//         }
//
//         static void GenMemberGetter<TTarget>(MemberInfo member, Type memberType, bool isStatic,
...
//         }
//
//         static void GenMemberSetter<TTarget>(MemberInfo member, Type memberType, bool isStatic,
...
//             {
//                 if (field.IsStatic) ldsfld(field);
//                 else ldfld(field);
//                 return this;
//             }
//
...
//             {
//                 if (field.IsStatic) stsfld(field);
//                 else stfld(field);
//                 return this;
//             }
//
...
//             {
//                 if (type.IsValueType) unbox(type);
//                 else cast(type);
//                 return this;
//             }
//
...
//             {
//                 if (method.IsVirtual) il.Emit(OpCodes.Callvirt, method);
//                 else il.Emit(OpCodes.Call, method);
//                 return this;
//             }
//
...
//             {
//                 if (type.IsValueType) emit.ldarga(idx);
//                 else emit.ldarg(idx);
//                 return this;
//             }
//
...
//             {
//                 if (type.IsValueType) emit.ldloca(idx);
//                 else emit.ldloc(idx);
//                 return this;
//             }
//
